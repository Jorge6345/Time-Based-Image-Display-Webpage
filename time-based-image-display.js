...
function setBackgroundImage () {
    ...
    if (currentTime >= 6 && currentTime < 12) {
        document.body.style.backgroundImage = "url('/Time-Based-Image-Display-Webpage/background-images/morning-background.jpg')";
        document.body.style.color = "black";
    }
    else if (currentTime >= 12 && currentTime < 18) {
        document.body.style.backgroundImage = "url('/Time-Based-Image-Display-Webpage/background-images/afternoon-background.jpg')";
        document.body.style.color = "black";
    }
    else {
        document.body.style.backgroundImage = "url('/Time-Based-Image-Display-Webpage/background-images/night-background.jpg')";
